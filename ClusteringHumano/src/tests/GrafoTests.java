...
class GrafoTests {
	...
	@Test
	void grafoDeDosVerticesVecinosEsConexoTest() {
		grafo.agregarVertice(vertice0);
		grafo.agregarVertice(vertice1);
	...
	void grafoNoConexoTest() {
		...
		grafo.agregarArista(vertice2, vertice4);
		grafo.agregarArista(vertice3, vertice4);
		grafo.agregarArista(vertice5, vertice0);
	...
	void verticeSeAlcanzaASiMismoTest() {
		...
		assertTrue(grafo.sonAlcanzablesEntreSi(vertice0, vertice0));
	}
	...
	void grafoDeDosVerticesQueSonAlcanzablesTest() {
		...
		assertTrue(grafo.sonAlcanzablesEntreSi(vertice0, vertice1));
	}
	...
	void verticesSonAlcanzablesTest() {
		...
		assertTrue(grafo.sonAlcanzablesEntreSi(vertice0, vertice4));
	}
	...
	void grafoDeDosVerticesQueNoSonAlcanzablesTest() {
		...
		assertFalse(grafo.sonAlcanzablesEntreSi(vertice0, vertice1));
	}
	...
	void verticesNoSonAlcanzablesTest() {
		...
		assertFalse(grafo.sonAlcanzablesEntreSi(vertice0, vertice6));
	}
	...
	@Test
	void grafoVacioNoEsArbolTest() {
		assertFalse(grafo.esArbol());
	}

	@Test
	void grafoDeUnVerticeEsArbolTest() {
		grafo.agregarVertice(vertice0);
	...
	@Test
	void noEsArbolPorNoSerConexoTest() {
		grafo.agregarVertice(vertice0);
		grafo.agregarVertice(vertice1);
		grafo.agregarVertice(vertice2);
		grafo.agregarVertice(vertice3);
	...
	@Test
	void grafoVacioNoEsCompletoTest() {
		assertFalse(grafo.esCompleto());
	}

	@Test
	void convertirAGrafoCompletoTest() {
		grafo.agregarVertice(vertice0);
		grafo.agregarVertice(vertice1);
		grafo.agregarVertice(vertice2);
		grafo.agregarVertice(vertice3);
	...
	@Test
	void convertirAGrafoCompletoYaTeniendoAristasTest() {
		grafo.agregarVertice(vertice0);
		grafo.agregarVertice(vertice1);
		grafo.agregarVertice(vertice2);
		grafo.agregarVertice(vertice3);
